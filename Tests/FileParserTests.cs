...
namespace FileParserTests
{
    public class FileParserTests
    {
        ...
        private string _csvPath = Environment.GetEnvironmentVariable("HOME") + "C:/Users/Jayde/OneDrive/Uni/Delegates Task/data.csv";  // change to appropriate path
        private string _tsvPath = Environment.GetEnvironmentVariable("HOME") + "C:/Users/Jayde/OneDrive/Uni/Delegates Task/data.tsv";  // change to appropriate path

        private string _writeFile = Environment.GetEnvironmentVariable("HOME") + "C:/Users/Jayde/OneDrive/Uni/Delegates Task/dataWrite.txt";  // change to appropriate path
